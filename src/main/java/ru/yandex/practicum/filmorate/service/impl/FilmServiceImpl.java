...
public class FilmServiceImpl implements FilmService {
    ...
    /**
     * Получение списка самых популярных фильмов. Под популярностью понимается количество оценок у фильма. Чем больше
    ...
    /**
     * Получение списка общих фильмов между двумя пользователями с сортировкой по их популярности.
     *
