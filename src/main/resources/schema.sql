DROP TABLE IF EXISTS GENRE, MPA, FILM, FILM_GENRE, FILMORATE_USER, FRIENDSHIP_STATUS, FRIENDSHIP, FILM_MARK,
REVIEW, REVIEW_LIKE, FEED_EVENTS, DIRECTOR, FILM_DIRECTOR;
...
CREATE TABLE IF NOT EXISTS FILM_MARK(
    ...
    USER_ID INTEGER NOT NULL,
    MARK INTEGER,
	CONSTRAINT pk_film_mark PRIMARY KEY (FILM_ID, USER_ID),
	FOREIGN KEY (FILM_ID) REFERENCES FILM(ID) ON DELETE CASCADE,
